...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		A2(
			...
			{language: 'markdown', saved: '', text: $author$project$Main$sampleLab},
...
var $author$project$Layout$dropShadow = $mdgriffith$elm_ui$Element$Border$shadow(
	{
		blur: 2,
		color: A4($mdgriffith$elm_ui$Element$rgba, 0, 0, 0, 0.2),
		offset: _Utils_Tuple2(-1.0, 1.0),
		size: 0.5
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Layout$defaultPadding,
				$author$project$Layout$dropShadow
			]),
		_List_fromArray(
			[model.content]));
};
...
var $author$project$Main$viewCodeEditor = function (settings) {
	...
	return enableMonaco ? A2(
		...
		_List_fromArray(
			...
			])) : A2($author$project$Editor$viewMultilineEditor, $author$project$Main$Save, editor);
};
...
var $author$project$Instructions$viewInstructions = F3(
	function (onNext, onDone, markdown) {
	...
	return {
		body: _List_fromArray(
			[
				...
				{
					content: $author$project$Main$viewCodeEditor(
						{enableMonaco: true, model: model}),
					detail: A3($author$project$Instructions$viewInstructions, $author$project$Main$onNext, $author$project$Main$Done, model.instructions),
					title: 'Editor'
				})
			]),
		title: 'Chiron Portal'
