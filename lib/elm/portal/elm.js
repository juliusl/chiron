...
{
	if (region.i.am === region.h.am)
	{
		return 'on line ' + region.i.am;
	}
	return 'on lines ' + region.i.am + ' through ' + region.h.am;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { dk: 'hidden', cX: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { dk: 'mozHidden', cX: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { dk: 'msHidden', cX: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { dk: 'webkitHidden', cX: 'webkitvisibilitychange' }
		: { dk: 'hidden', cX: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		function done(response) {
			callback(toTask(request.dc.a(response)));
		}

		var xhr = new XMLHttpRequest();
		xhr.addEventListener('error', function() { done($elm$http$Http$NetworkError_); });
		xhr.addEventListener('timeout', function() { done($elm$http$Http$Timeout_); });
		xhr.addEventListener('load', function() { done(_Http_toResponse(request.dc.b, xhr)); });
		$elm$core$Maybe$isJust(request.cg) && _Http_track(router, xhr, request.cg.a);

		try {
			xhr.open(request.dH, request.eQ, true);
		} catch (e) {
...
function _Http_configureRequest(xhr, request)
{
	...
	xhr.responseType = request.dc.d;
	xhr.withCredentials = request.cD;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bx: fragment, bF: host, bX: path, bZ: port_, b0: protocol, b1: query};
	});
...
var $author$project$Main$Model = F2(
	function (editor, instructions) {
		return {O: editor, af: instructions};
	});
			...
			return $elm$http$Http$Request(
				{
					cD: r.cD,
					cM: r.cM,
					dc: A2(_Http_mapExpect, func, r.dc),
					bA: r.bA,
					dH: r.dH,
					eJ: r.eJ,
					cg: r.cg,
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{cD: false, cM: r.cM, dc: r.dc, bA: r.bA, dH: r.dH, eJ: r.eJ, cg: r.cg, eQ: r.eQ}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{cM: $elm$http$Http$emptyBody, dc: r.dc, bA: _List_Nil, dH: 'GET', eJ: $elm$core$Maybe$Nothing, cg: $elm$core$Maybe$Nothing, eQ: r.eQ});
};
var $author$project$Main$getLab = function (lab) {
	return $elm$http$Http$get(
		{
			dc: $elm$http$Http$expectString($author$project$Main$GotLab),
			eQ: $elm$core$String$concat(
				_List_fromArray(
					['/lab/', lab]))
		});
};
var $author$project$Main$sampleLab = '\n# Lab - Setup a dev-box \n```yaml\nid: "devbox-setup-2"\ndisplay_name: "Devbox Setup"\ndescription: "Learn how to setup your own devbox"\ndepends_on:\n- kind\ntools:\n- az_cli:\n  - az vm create\n```\n## Generate an ssh key\n```yaml\nrequires:\n- id_rsa_pub:\ntools:\n- bash:\n  - ssh-keygen\n```\n';
	...
	if (!maybelab.$) {
		...
		return _Utils_Tuple2(
			A2(
				...
				{bN: 'markdown', ao: '', aQ: $author$project$Main$sampleLab},
				$author$project$Main$sampleLab),
...
var $author$project$Main$saveContent = _Platform_incomingPort('saveContent', $elm$json$Json$Decode$string);
	...
	function (msg, model) {
		...
		switch (msg.$) {
			...
			case 1:
				...
				return _Utils_Tuple2(
					model,
					$author$project$Main$dispatchEditorCmd(cmd));
			case 3:
				var instructions = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{af: instructions}),
...
var $mdgriffith$elm_ui$Internal$Model$asColumn = 1;
var $mdgriffith$elm_ui$Internal$Style$classes = {ct: 'a', aU: 'atv', cv: 'ab', cw: 'cx', cx: 'cy', cy: 'acb', cz: 'accx', cA: 'accy', cB: 'acr', bj: 'al', bk: 'ar', cC: 'at', aV: 'ah', aW: 'av', cF: 's', cJ: 'bh', cK: 'b', cN: 'w7', cP: 'bd', cQ: 'bdt', av: 'bn', cR: 'bs', aw: 'cpe', cZ: 'cp', c_: 'cpx', c$: 'cpy', M: 'c', aB: 'ctr', aC: 'cb', aD: 'ccx', N: 'ccy', al: 'cl', aE: 'cr', c2: 'ct', c4: 'cptr', c5: 'ctxt', df: 'fcs', bw: 'focus-within', dg: 'fs', dh: 'g', a$: 'hbh', a0: 'hc', bC: 'he', a1: 'hf', bD: 'hfp', dl: 'hv', $7: 'ic', dq: 'fr', aH: 'lbl', ds: 'iml', dt: 'imlf', du: 'imlp', dv: 'implw', dw: 'it', dz: 'i', dD: 'lnk', ag: 'nb', bR: 'notxt', dN: 'ol', dO: 'or', Y: 'oq', dU: 'oh', bW: 'pg', dV: 'p', dW: 'ppe', d1: 'ui', d2: 'r', d4: 'sb', d5: 'sbx', d6: 'sby', d7: 'sbt', ea: 'e', eb: 'cap', ec: 'sev', ej: 'sk', aQ: 't', eu: 'tc', ev: 'w8', ew: 'w2', ex: 'w9', ey: 'tj', aR: 'tja', ez: 'tl', eA: 'w3', eB: 'w5', eC: 'w4', eD: 'tr', eE: 'w6', eF: 'w1', eG: 'tun', ci: 'ts', aa: 'clr', eN: 'u', bf: 'wc', co: 'we', bg: 'wf', cp: 'wfp', bh: 'wrp'};
...
var $mdgriffith$elm_ui$Internal$Model$gridClass = $mdgriffith$elm_ui$Internal$Style$classes.cF + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dh);
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.cF + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bW);
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.cF + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dV);
var $mdgriffith$elm_ui$Internal$Model$rowClass = $mdgriffith$elm_ui$Internal$Style$classes.cF + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.d2);
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.cF + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.ea);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.H)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.ed.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.ed.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.d2) + ('-' + ($elm$core$String$fromInt(pos.A) + ('-' + ($elm$core$String$fromInt(pos.cn) + ('-' + $elm$core$String$fromInt(pos.bB)))))));
		case 11:
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.dl, $mdgriffith$elm_ui$Internal$Style$classes.aa)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.dl, $mdgriffith$elm_ui$Internal$Style$classes.Y)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.df, $mdgriffith$elm_ui$Internal$Style$classes.Y)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.aU, $mdgriffith$elm_ui$Internal$Style$classes.Y)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cF) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.d2) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cF) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cF) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.d2) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cF) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.aB) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$inputTextReset + ($mdgriffith$elm_ui$Internal$Style$sliderReset + ($mdgriffith$elm_ui$Internal$Style$trackReset + ($mdgriffith$elm_ui$Internal$Style$thumbReset + $mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
var $mdgriffith$elm_ui$Internal$Style$Intermediate = $elm$core$Basics$identity;
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {aA: closing, t: _List_Nil, R: _List_Nil, F: selector};
	});
					...
					case 3:
						...
						return _Utils_update(
							rendered,
							{
								t: A2(
									$elm$core$List$cons,
									{aA: '\n}', t: _List_Nil, R: props, F: '@supports (' + (prop + (':' + (value + (') {' + parent.F))))},
									rendered.t)
							});
					case 5:
						var selector = rule.a;
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.F + ('{' + (renderValues(rule.R) + (rule.aA + '}')));
		}
	};
	var renderIntermediate = function (_v0) {
		...
		return _Utils_ap(
			...
			$elm$core$String$concat(
				A2($elm$core$List$map, renderIntermediate, rule.t)));
	};
	return $elm$core$String$concat(
		A2(
			$elm$core$List$map,
	...
	function (options, rule, maybePseudo) {
		switch (rule.$) {
			...
			case 5:
				...
				var paragraph = '.' + $mdgriffith$elm_ui$Internal$Style$classes.dV;
			...
			case 9:
				...
				var msPosition = A2(
					...
					_List_fromArray(
						[
							...
							'-ms-grid-row-span: ' + ($elm$core$String$fromInt(position.bB) + ';'),
							'-ms-grid-column: ' + ($elm$core$String$fromInt(position.A) + ';'),
				...
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							'grid-row: ' + ($elm$core$String$fromInt(position.d2) + (' / ' + ($elm$core$String$fromInt(position.d2 + position.bB) + ';'))),
							'grid-column: ' + ($elm$core$String$fromInt(position.A) + (' / ' + ($elm$core$String$fromInt(position.A + position.cn) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.d2) + ('-' + ($elm$core$String$fromInt(position.A) + ('-' + ($elm$core$String$fromInt(position.cn) + ('-' + $elm$core$String$fromInt(position.bB)))))));
	...
	function (name, modifier, _v0) {
		...
		return _List_fromArray(
			[
				...
				A2($mdgriffith$elm_ui$Internal$Model$bracket, '.' + (name + ('.' + (modifier + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.aQ + (', .' + (name + (' .' + (modifier + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.aQ)))))))))), textAdjustment)
			]);
	});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.eb + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.aQ + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.eb + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.aQ)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {bB: height / size, cb: size, cl: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.cV, adjustment.cI, adjustment.c6, adjustment.dE]);
	var lineHeight = 1.5;
	...
	return _Utils_Tuple2(
		...
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'line-height',
				$elm$core$String$fromFloat(converted.bB)),
				_Utils_Tuple2(
				'vertical-align',
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.cF + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.ea))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cF, $mdgriffith$elm_ui$Internal$Style$classes.ea, $mdgriffith$elm_ui$Internal$Style$classes.aB, $mdgriffith$elm_ui$Internal$Style$classes.N, $mdgriffith$elm_ui$Internal$Style$classes.cB])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cF, $mdgriffith$elm_ui$Internal$Style$classes.ea, $mdgriffith$elm_ui$Internal$Style$classes.aB, $mdgriffith$elm_ui$Internal$Style$classes.N, $mdgriffith$elm_ui$Internal$Style$classes.cz])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cF, $mdgriffith$elm_ui$Internal$Style$classes.ea, $mdgriffith$elm_ui$Internal$Style$classes.aB, $mdgriffith$elm_ui$Internal$Style$classes.cA])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cF, $mdgriffith$elm_ui$Internal$Style$classes.ea, $mdgriffith$elm_ui$Internal$Style$classes.aB, $mdgriffith$elm_ui$Internal$Style$classes.cy])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.cF + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aQ + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.bf + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.a0)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.cF + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aQ + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.bg + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.a1)))));
					...
					case 1:
						...
						return _Utils_eq(context, $mdgriffith$elm_ui$Internal$Model$asParagraph) ? _Utils_Tuple2(
							A2(
								...
								_Utils_Tuple2(
									key,
									A2(styled.dm, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, context)),
								htmls),
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ag, $mdgriffith$elm_ui$Internal$Style$classes.ea, $mdgriffith$elm_ui$Internal$Style$classes.ct]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ag, $mdgriffith$elm_ui$Internal$Style$classes.ea, $mdgriffith$elm_ui$Internal$Style$classes.cK]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ag, $mdgriffith$elm_ui$Internal$Style$classes.ea, $mdgriffith$elm_ui$Internal$Style$classes.dO]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ag, $mdgriffith$elm_ui$Internal$Style$classes.ea, $mdgriffith$elm_ui$Internal$Style$classes.dN]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ag, $mdgriffith$elm_ui$Internal$Style$classes.ea, $mdgriffith$elm_ui$Internal$Style$classes.dq]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ag, $mdgriffith$elm_ui$Internal$Style$classes.ea, $mdgriffith$elm_ui$Internal$Style$classes.cJ]));
						}
					}())
				]),
			_List_fromArray(
				[
					...
					switch (elem.$) {
						...
						default:
							var styled = elem.a;
							return A2(styled.dm, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, $mdgriffith$elm_ui$Internal$Model$asEl);
					}
				}()
				]));
	});
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
						$mdgriffith$elm_ui$Internal$Style$classes.cF + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.d2 + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.c2 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.al)),
				A2(
					$elm$core$List$cons,
...
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
				...
				case 0:
					...
					if (_v4.$ === 1) {
						return _Utils_update(
							record,
							{
								dl: $elm$core$Maybe$Just(hoverable)
							});
					} else {
						return record;
					}
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{df: $elm$core$Maybe$Nothing, dl: $elm$core$Maybe$Nothing, dI: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.d1, $mdgriffith$elm_ui$Internal$Style$classes.cF, $mdgriffith$elm_ui$Internal$Style$classes.ea]))),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Background$color(
				A3($mdgriffith$elm_ui$Element$rgb255, 165, 165, 141))
			]),
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$text(model.cf)
			]));
};
var $mdgriffith$elm_ui$Element$fillPortion = $mdgriffith$elm_ui$Internal$Model$Fill;
var $author$project$Layout$viewContent = function (model) {
	return A2(
...
var $author$project$Layout$viewDetail = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
...
var $author$project$Layout$viewGutter = function (_v0) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
...
var $author$project$Layout$view = function (model) {
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					$author$project$Layout$viewHeader(model),
					$author$project$Layout$viewPage(model),
...
var $author$project$Markdown$code = function (snippet) {
	return A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						{bQ: 'Source Code Pro', eQ: 'https://fonts.googleapis.com/css?family=Source+Code+Pro'})
					]))
			]),
...
var $dillonkearns$elm_markdown$Markdown$Parser$deadEndToString = function (deadEnd) {
	return 'Problem at row ' + ($elm$core$String$fromInt(deadEnd.d2) + ('\n' + $dillonkearns$elm_markdown$Markdown$Parser$problemToString(deadEnd.dY)));
};
	...
	return $elm$core$String$concat(
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Model$formatColorClass(shadow.ad)
			]));
};
var $mdgriffith$elm_ui$Internal$Flag$shadows = $mdgriffith$elm_ui$Internal$Flag$flag(19);
var $mdgriffith$elm_ui$Element$Border$shadow = function (almostShade) {
	var shade = {ac: almostShade.ac, ad: almostShade.ad, bJ: false, d: almostShade.d, cb: almostShade.cb};
	return A2(
		$mdgriffith$elm_ui$Internal$Model$StyleClass,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				{
					ac: 1,
					ad: checked ? A4($mdgriffith$elm_ui$Element$rgba, 238 / 255, 238 / 255, 238 / 255, 0) : A3($mdgriffith$elm_ui$Element$rgb, 238 / 255, 238 / 255, 238 / 255),
					d: _Utils_Tuple2(0, 0),
					cb: 1
				}),
				$mdgriffith$elm_ui$Element$Background$color(
...
var $author$project$Markdown$formatCodeBlock = function (content) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
...
var $author$project$Markdown$rawTextToId = function (rawText) {
...
var $author$project$Markdown$heading_one = F2(
	function (level, rawText) {
		return _List_fromArray(
			[
				...
				A2(
					...
					'name',
					$author$project$Markdown$rawTextToId(rawText))),
				$mdgriffith$elm_ui$Element$htmlAttribute(
				$elm$html$Html$Attributes$id(
					$author$project$Markdown$rawTextToId(rawText)))
			]);
	});
var $mdgriffith$elm_ui$Element$Font$underline = $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.eN);
var $author$project$Markdown$heading_two = F2(
	function (level, rawText) {
		return _List_fromArray(
			[
...
var $author$project$Markdown$heading = function (_v0) {
	var level = _v0.dC;
	var rawText = _v0.dZ;
	var children = _v0.cY;
	return A2(
		...
		function () {
			switch (level) {
				case 0:
					return A2(
						$author$project$Markdown$heading_one,
						$dillonkearns$elm_markdown$Markdown$Block$headingLevelToInt(level),
						rawText);
				case 1:
					return A2(
						$author$project$Markdown$heading_two,
						$dillonkearns$elm_markdown$Markdown$Block$headingLevelToInt(level),
						rawText);
				default:
					return _List_fromArray(
...
var $mdgriffith$elm_ui$Element$Font$italic = $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.dz);
					...
					A2(
						...
						A2(
							...
							A2(
								...
								A2(
									$elm$core$List$cons,
									$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.aD + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.N + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dD)))),
									attrs)))))),
			$mdgriffith$elm_ui$Internal$Model$Unkeyed(
				_List_fromArray(
					[label])));
...
var $elm$parser$Parser$Advanced$chompWhileHelp = F5(
	function (isGood, offset, row, col, s0) {
		chompWhileHelp:
		while (true) {
			var newOffset = A3($elm$parser$Parser$Advanced$isSubChar, isGood, offset, s0.aP);
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					$elm$parser$Parser$Advanced$Good,
					_Utils_cmp(s0.d, offset) < 0,
					0,
					{A: col, g: s0.g, J: s0.J, d: offset, d2: row, aP: s0.aP});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.d, s.d2, s.A, s);
	};
};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {A: col, c3: contextStack, dY: problem, d2: row};
	});
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.d2, s.A, x, s.g));
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.d, s.d2, s.A, s.aP);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{A: newCol, g: s.g, J: s.J, d: newOffset, d2: newRow, aP: s.aP});
	};
};
		...
		return function (s0) {
			...
			if (_v1.$ === 1) {
				...
				return A3(
					...
					A2(
						func,
						A3($elm$core$String$slice, s0.d, s1.d, s0.aP),
						a),
					s1);
			}
		};
...
var $elm$parser$Parser$Advanced$chompIf = F2(
	function (isGood, expecting) {
		return function (s) {
			var newOffset = A3($elm$parser$Parser$Advanced$isSubChar, isGood, s.d, s.aP);
			return _Utils_eq(newOffset, -1) ? A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				...
				true,
				0,
				{A: 1, g: s.g, J: s.J, d: s.d + 1, d2: s.d2 + 1, aP: s.aP}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{A: s.A + 1, g: s.g, J: s.J, d: newOffset, d2: s.d2, aP: s.aP}));
		};
	});
...
var $elm$parser$Parser$Advanced$chompUntilEndOr = function (str) {
	return function (s) {
		var _v0 = A5(_Parser_findSubString, str, s.d, s.d2, s.A, s.aP);
		var newOffset = _v0.a;
		var newRow = _v0.b;
		var newCol = _v0.c;
		var adjustedOffset = (newOffset < 0) ? $elm$core$String$length(s.aP) : newOffset;
		return A3(
			$elm$parser$Parser$Advanced$Good,
			_Utils_cmp(s.d, adjustedOffset) < 0,
			0,
			{A: newCol, g: s.g, J: s.J, d: adjustedOffset, d2: newRow, aP: s.aP});
	};
};
...
var $dillonkearns$elm_markdown$Markdown$OrderedList$ListItem = F4(
	function (order, intended, marker, body) {
		return {cM: body, dx: intended, dF: marker, dS: order};
	});
...
var $dillonkearns$elm_markdown$Markdown$Parser$orderedListBlock = function (previousWasBody) {
	return A2(
		$elm$parser$Parser$Advanced$map,
		function (item) {
			return A6($dillonkearns$elm_markdown$Markdown$RawBlock$OrderedListBlock, true, item.dx, item.dF, item.dS, _List_Nil, item.cM);
		},
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$matchToInline = function (_v0) {
	...
	switch (_v1.$) {
		case 0:
			return $dillonkearns$elm_markdown$Markdown$Inline$Text(match.aQ);
		case 1:
			return $dillonkearns$elm_markdown$Markdown$Inline$HardLineBreak;
		case 2:
			return $dillonkearns$elm_markdown$Markdown$Inline$CodeInline(match.aQ);
		case 3:
			var _v2 = _v1.a;
			var text = _v2.a;
			var url = _v2.b;
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$prepareChildMatch = F2(
	function (parentMatch, childMatch) {
		return {h: childMatch.h - parentMatch.r, p: childMatch.p, i: childMatch.i - parentMatch.r, aQ: childMatch.aQ, w: childMatch.w - parentMatch.r, r: childMatch.r - parentMatch.r, k: childMatch.k};
	});
	...
	function (remaining, _v0, matchesTail) {
		...
		while (true) {
			...
			if (!remaining.b) {
				...
				if (_Utils_cmp(prevMatch.h, match.i) < 1) {
					...
					if ((_Utils_cmp(prevMatch.i, match.i) < 0) && (_Utils_cmp(prevMatch.h, match.h) > 0)) {
						var $temp$remaining = rest,
...
var $elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {c: index, dG: match, dL: number, bd: submatches};
	});
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$normalMatch = function (text) {
	return {
		...
		p: _List_Nil,
		i: 0,
		aQ: $dillonkearns$elm_markdown$Markdown$Helpers$formatStr(text),
		w: 0,
		r: 0,
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$parseTextMatch = F3(
	function (rawText, _v2, parsedMatches) {
		...
		var updtMatch = {
			h: matchModel.h,
			p: A3($dillonkearns$elm_markdown$Markdown$InlineParser$parseTextMatches, matchModel.aQ, _List_Nil, matchModel.p),
			i: matchModel.i,
			aQ: matchModel.aQ,
			w: matchModel.w,
			r: matchModel.r,
		...
		if (!parsedMatches.b) {
			var finalStr = A2($elm$core$String$dropLeft, matchModel.h, rawText);
			...
			if (!_v4.$) {
				...
				return _Utils_eq(matchModel.h, matchHead.i) ? A2($elm$core$List$cons, updtMatch, parsedMatches) : ((_Utils_cmp(matchModel.h, matchHead.i) < 0) ? A2(
					$elm$core$List$cons,
					updtMatch,
					A2(
						$elm$core$List$cons,
						$dillonkearns$elm_markdown$Markdown$InlineParser$normalMatch(
							A3($elm$core$String$slice, matchModel.h, matchHead.i, rawText)),
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToAngleBracketLToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		return $dillonkearns$elm_markdown$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
			{c: regMatch.c + backslashesLength, a3: 1, e: $dillonkearns$elm_markdown$Markdown$InlineParser$AngleBracketOpen}) : $elm$core$Maybe$Nothing;
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToCodeToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		return $elm$core$Maybe$Just(
			{
				c: regMatch.c + backslashesLength,
				a3: $elm$core$String$length(backtick),
	...
	while (true) {
		if (_v0.b) {
			if (!_v0.a.$) {
				...
				return (!$dillonkearns$elm_markdown$Markdown$Helpers$isEven(backslashesLength)) ? $elm$core$Maybe$Just(
					{c: (regMatch.c + backslashesLength) - 1, a3: 2, e: $dillonkearns$elm_markdown$Markdown$InlineParser$HardLineBreakToken}) : $elm$core$Maybe$Nothing;
			} else {
				if (_v0.b.b && (!_v0.b.a.$)) {
					var _v1 = _v0.b;
					return $elm$core$Maybe$Just(
						{
							c: regMatch.c,
							a3: $elm$core$String$length(regMatch.dG),
	...
	while (true) {
		if (_v0.b) {
			if (!_v0.a.$) {
				...
				var backslashesLength = $elm$core$String$length(backslashes);
				return $dillonkearns$elm_markdown$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
					{c: regMatch.c + backslashesLength, a3: 1, e: $dillonkearns$elm_markdown$Markdown$InlineParser$HardLineBreakToken}) : $elm$core$Maybe$Just(
					{c: (regMatch.c + backslashesLength) - 1, a3: 2, e: $dillonkearns$elm_markdown$Markdown$InlineParser$HardLineBreakToken});
			} else {
				if (_v0.b.b) {
					var _v1 = _v0.b;
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToLinkImageCloseToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		var backslashesLength = A2(
			...
			A2($elm$core$Maybe$map, $elm$core$String$length, maybeBackslashes));
		return $dillonkearns$elm_markdown$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
			{c: regMatch.c + backslashesLength, a3: 1, e: $dillonkearns$elm_markdown$Markdown$InlineParser$SquareBracketClose}) : $elm$core$Maybe$Nothing;
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToLinkImageOpenToken = function (regMatch) {
	...
	if (((_v0.b && _v0.b.b) && _v0.b.b.b) && (!_v0.b.b.a.$)) {
		...
		if (isEscaped) {
			...
			if (!maybeImageOpen.$) {
				return $elm$core$Maybe$Just(
					{c: index, a3: 2, e: $dillonkearns$elm_markdown$Markdown$InlineParser$ImageOpenToken});
			} else {
				return $elm$core$Maybe$Just(
					{
						c: index,
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToStrikethroughToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		var meaning = _v2.b;
		return $elm$core$Maybe$Just(
			{c: regMatch.c + backslashesLength, a3: length, e: meaning});
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
	...
	A2(
		...
		function (match) {
			return A2(
				$elm$core$Maybe$withDefault,
				match.dG,
				$elm$url$Url$percentDecode(match.dG));
		}));
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$autolinkToMatch = function (_v0) {
	var match = _v0;
	return A2($elm$regex$Regex$contains, $dillonkearns$elm_markdown$Markdown$InlineParser$urlRegex, match.aQ) ? $elm$core$Result$Ok(
		_Utils_update(
			match,
			{
				k: $dillonkearns$elm_markdown$Markdown$InlineParser$AutolinkType(
					_Utils_Tuple2(
						match.aQ,
						$dillonkearns$elm_markdown$Markdown$InlineParser$encodeUrl(match.aQ)))
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$refRegexToMatch = F3(
	function (matchModel, references, maybeRegexMatch) {
		var refLabel = function (str) {
			return $elm$core$String$isEmpty(str) ? matchModel.aQ : str;
		}(
			A2(
				$elm$core$Maybe$withDefault,
				matchModel.aQ,
		...
		if (_v0.$ === 1) {
			...
			var regexMatchLength = function () {
				if (!maybeRegexMatch.$) {
					var match = maybeRegexMatch.a.dG;
			...
			return $elm$core$Maybe$Just(
				_Utils_update(
					matchModel,
					{h: matchModel.h + regexMatchLength, k: type_}));
		}
	});
		...
		if ((((_v0.b && _v0.b.b) && _v0.b.b.b) && _v0.b.b.b.b) && _v0.b.b.b.b.b) {
			...
			var toMatch = function (rawUrl) {
				return _Utils_update(
					matchModel,
					{
						h: matchModel.h + $elm$core$String$length(regexMatch.dG),
						k: function () {
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$checkParsedAheadOverlapping = F2(
	function (_v0, remainMatches) {
		...
		var overlappingMatches = $elm$core$List$filter(
			function (_v1) {
				var testMatch = _v1;
				return (_Utils_cmp(match.h, testMatch.i) > 0) && (_Utils_cmp(match.h, testMatch.h) < 0);
			});
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$emailAutolinkTypeToMatch = function (_v0) {
	var match = _v0;
	return A2($elm$regex$Regex$contains, $dillonkearns$elm_markdown$Markdown$InlineParser$emailRegex, match.aQ) ? $elm$core$Result$Ok(
		_Utils_update(
			match,
			{
				k: $dillonkearns$elm_markdown$Markdown$InlineParser$AutolinkType(
					_Utils_Tuple2(
						match.aQ,
						'mailto:' + $dillonkearns$elm_markdown$Markdown$InlineParser$encodeUrl(match.aQ)))
			})) : $elm$core$Result$Err(match);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{A: 1, g: _List_Nil, J: 1, d: 0, d2: 1, aP: src});
		if (!_v1.$) {
			var value = _v1.b;
					...
					$elm$parser$Parser$Advanced$succeed(
						F3(
							function (startOffset, htmlTag, endOffset) {
								return {bG: htmlTag, a3: endOffset - startOffset};
							})),
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$isCodeTokenPair = F2(
	function (closeToken, openToken) {
		...
		if (!_v0.$) {
			if (!_v0.a) {
				var _v1 = _v0.a;
				return _Utils_eq(openToken.a3 - 1, closeToken.a3);
			} else {
				var _v2 = _v0.a;
				return _Utils_eq(openToken.a3, closeToken.a3);
			}
		} else {
			return false;
		}
	...
	function (closeToken, openToken) {
		...
		if (_v0.$ === 7) {
			...
			if (_v1.$ === 7) {
				var closeChar = _v1.a;
				var close = _v1.b;
				return _Utils_eq(openChar, closeChar) ? ((_Utils_eq(open.aK, open.aM) || _Utils_eq(close.aK, close.aM)) ? ((!(!A2($elm$core$Basics$modBy, 3, closeToken.a3 + openToken.a3))) || ((!A2($elm$core$Basics$modBy, 3, closeToken.a3)) && (!A2($elm$core$Basics$modBy, 3, openToken.a3)))) : true) : false;
			} else {
				return false;
			}
		} else {
	...
	function (closeToken, openToken) {
		var _v0 = function () {
			...
			if (_v1.$ === 10) {
				if (!_v1.a) {
					var _v2 = _v1.a;
					return _Utils_Tuple2(true, openToken.a3 - 1);
				} else {
					var _v3 = _v1.a;
					return _Utils_Tuple2(true, openToken.a3);
				}
			} else {
		...
		var _v4 = function () {
			...
			if (_v5.$ === 10) {
				if (!_v5.a) {
					var _v6 = _v5.a;
					return _Utils_Tuple2(true, closeToken.a3 - 1);
				} else {
					var _v7 = _v5.a;
					return _Utils_Tuple2(true, closeToken.a3);
				}
			} else {
				return _Utils_Tuple2(false, 0);
			}
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$tokenToMatch = F2(
	function (token, type_) {
		return {h: token.c + token.a3, p: _List_Nil, i: token.c, aQ: '', w: 0, r: 0, k: type_};
	});
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$removeParsedAheadTokens = F2(
	function (_v0, tokensTail) {
		...
		return A2(
			$elm$core$List$filter,
			function (token) {
				return _Utils_cmp(token.c, match.h) > -1;
			},
			tokensTail);
	});
	...
	function (closeToken, matches, references, rawText, _v34) {
		...
		var updatedOpenToken = function () {
			...
			if ((!_v35.$) && (!_v35.a)) {
				...
				return _Utils_update(
					openToken,
					{c: openToken.c + 1, a3: openToken.a3 - 1});
			} else {
				return openToken;
			}
		}();
	...
	function (remaining, tokens, matches, references, rawText) {
		...
		while (true) {
			if (!remaining.b) {
				...
				if (_v29.$ === 7) {
					var _char = _v29.a;
					var leftFringeRank = _v29.b.aK;
					var rightFringeRank = _v29.b.aM;
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$emphasisToMatch = F5(
	function (references, rawText, closeToken, tokensTail, _v27) {
		...
		var remainLength = openToken.a3 - closeToken.a3;
		var updt = (!remainLength) ? {az: closeToken, an: openToken, aL: remainTokens, aT: tokensTail} : ((remainLength > 0) ? {
			az: closeToken,
			an: _Utils_update(
				openToken,
				{c: openToken.c + remainLength, a3: closeToken.a3}),
			aL: A2(
				$elm$core$List$cons,
				_Utils_update(
					openToken,
			...
			aT: A2(
				...
				_Utils_update(
					closeToken,
					{c: closeToken.c + openToken.a3, a3: -remainLength}),
				tokensTail)
		});
		var match = A7(
			$dillonkearns$elm_markdown$Markdown$InlineParser$tokenPairToMatch,
			...
			$dillonkearns$elm_markdown$Markdown$InlineParser$EmphasisType(updt.an.a3),
			updt.an,
			updt.az,
			$elm$core$List$reverse(innerTokens));
		return _Utils_Tuple3(updt.aT, match, updt.aL);
	});
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$tokenPairToMatch = F7(
	function (references, rawText, processText, type_, openToken, closeToken, innerTokens) {
		var textStart = openToken.c + openToken.a3;
		var textEnd = closeToken.c;
		var text = processText(
			A3($elm$core$String$slice, textStart, textEnd, rawText));
		var start = openToken.c;
		var end = closeToken.c + closeToken.a3;
		var match = {h: end, p: _List_Nil, i: start, aQ: text, w: textEnd, r: textStart, k: type_};
		var matches = A2(
			$elm$core$List$map,
			function (_v0) {
				var matchModel = _v0;
		...
		return {h: end, p: matches, i: start, aQ: text, w: textEnd, r: textStart, k: type_};
	});
			...
			return A3(
				...
				F2(
					function (headerCell, alignment) {
						return {au: alignment, dA: headerCell};
					}),
				headers,
				columnAlignments);
		};
...
var $dillonkearns$elm_markdown$Parser$Token$backtick = A2(
	...
	'`',
	$elm$parser$Parser$Expecting('a \'`\''));
var $dillonkearns$elm_markdown$Markdown$CodeBlock$backtick = {ax: '`', aI: 0, aS: $dillonkearns$elm_markdown$Parser$Token$backtick};
...
var $dillonkearns$elm_markdown$Parser$Token$tilde = A2(
	...
	'~',
	$elm$parser$Parser$Expecting('a `~`'));
var $dillonkearns$elm_markdown$Markdown$CodeBlock$tilde = {ax: '~', aI: 1, aS: $dillonkearns$elm_markdown$Parser$Token$tilde};
			...
			$elm$parser$Parser$Advanced$succeed(
				F2(
					function (indent, _v0) {
						var character = _v0.a;
						var length = _v0.b;
						return {ay: character, a2: indent, a3: length};
					})),
...
var $elm$parser$Parser$Advanced$getSource = function (s) {
	return A3($elm$parser$Parser$Advanced$Good, false, s.aP, s);
};
		...
		_List_fromArray(
			[
				...
				A2(
					...
					$elm$parser$Parser$Advanced$succeed(
						$elm$parser$Parser$Advanced$Done(body)),
					A2($dillonkearns$elm_markdown$Markdown$CodeBlock$closingFence, fence.a3, fence.ay))),
				A2(
				$elm$parser$Parser$Advanced$keeper,
				A2(
					$elm$parser$Parser$Advanced$keeper,
					A2(
						...
						$dillonkearns$elm_markdown$Markdown$CodeBlock$codeBlockLine(fence.a2)),
					$elm$parser$Parser$Advanced$getOffset),
...
var $elm$parser$Parser$Advanced$chompUntil = function (_v0) {
	...
	var expecting = _v0.b;
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$findSubString, str, s.d, s.d2, s.A, s.aP);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
...
var $elm$parser$Parser$Advanced$Located = F3(
	function (row, col, context) {
		return {A: col, g: context, d2: row};
	});
var $elm$parser$Parser$Advanced$changeContext = F2(
	function (newContext, s) {
		return {A: s.A, g: newContext, J: s.J, d: s.d, d2: s.d2, aP: s.aP};
	});
		...
		return function (s0) {
			var _v1 = parse(
				A2(
					...
					A2(
						$elm$core$List$cons,
						A3($elm$parser$Parser$Advanced$Located, s0.d2, s0.A, context),
						s0.g),
					s0));
			if (!_v1.$) {
				var p = _v1.a;
		...
		function (listmarker, intended, unparsedListItem) {
			switch (unparsedListItem.$) {
				...
				case 1:
					...
					return {cM: body, dF: listmarker, l: $elm$core$Maybe$Nothing};
				default:
					return {cM: '', dF: listmarker, l: $elm$core$Maybe$Nothing};
			}
		});
	return A2(
		$elm$parser$Parser$Advanced$map,
							...
							return $elm$parser$Parser$Advanced$succeed(
								{
									...
									b: A2(
										...
										$dillonkearns$elm_markdown$Markdown$RawBlock$CodeBlock(
											{
												cM: A2($dillonkearns$elm_markdown$Markdown$Parser$joinStringsPreserveAll, block2.cM, block1.cM),
										...
										b: A2(
											...
											A4(
												...
												_Utils_update(
													openListItem2,
													{
														cM: A3($dillonkearns$elm_markdown$Markdown$Parser$joinRawStringsWith, '\n', openListItem2.cM, body1)
													})),
											rest)
									});
							default:
			...
			function (_v24) {
				...
				return A3(
					...
					function (parsedHeaderLabel) {
						return {au: alignment, dA: parsedHeaderLabel};
					},
					label);
			},
			header);
	...
	function (linkReferences, rawBlock) {
		switch (rawBlock.$) {
					...
					A2(
						...
						$elm$core$List$reverse(
							A2(
								$elm$core$List$map,
								function (item) {
									return A2(parseItem, item.l, item.cM);
								},
								unparsedItems))));
			case 4:
				var tight = rawBlock.a;
			...
			case 6:
				...
				return $dillonkearns$elm_markdown$Markdown$Parser$ParsedBlock(
					$dillonkearns$elm_markdown$Markdown$Block$CodeBlock(
						{cM: codeBlockBody, bN: $elm$core$Maybe$Nothing}));
			case 8:
				var _v22 = rawBlock.a;
				var header = _v22.a;
				var rows = _v22.b;
			...
			case 9:
				...
				return $dillonkearns$elm_markdown$Markdown$Parser$ParsedBlock(
					$dillonkearns$elm_markdown$Markdown$Block$Paragraph(
						A2($dillonkearns$elm_markdown$Markdown$Parser$inlineParseHelper, linkReferences, text.b2)));
			default:
				var raw = rawBlock.b;
				return $dillonkearns$elm_markdown$Markdown$Parser$ParsedBlock(
					$dillonkearns$elm_markdown$Markdown$Block$Paragraph(
													...
													A2(
														...
														A4(
															...
															_Utils_update(
																openListItem,
																{
																	cM: A3($dillonkearns$elm_markdown$Markdown$Parser$joinRawStringsWith, '', openListItem.cM, newString)
																})),
														rest))
											});
									});
								...
								if (_v3.b.b) {
									switch (_v3.b.a.$) {
										case 3:
											...
											return ($elm$core$String$trim(openListItem.cM) === '') ? A2(
												$elm$parser$Parser$Advanced$map,
												function (block) {
													return $elm$parser$Parser$Advanced$Loop(block);
												},
	...
	return function (block) {
		switch (block.$) {
							...
							return renderer.dj(
								{
									cY: children,
									dC: level,
									dZ: $dillonkearns$elm_markdown$Markdown$Block$extractInlineText(content)
								});
						},
			...
			case 7:
				...
				return $elm$core$Maybe$Just(
					$elm$core$Result$Ok(
						renderer.c0(codeBlock)));
			case 8:
				return $elm$core$Maybe$Just(
					$elm$core$Result$Ok(renderer.eH));
			case 3:
								...
								renderer.et(
									A2(
										...
										function (_v10) {
											...
											var item = _v10.b;
											return A2(renderer.es, maybeAlignment, item);
										},
										listListView))));
					},
					renderedHeaderCells);
...
var $dillonkearns$elm_markdown$Markdown$Renderer$renderSingleInline = F2(
	function (renderer, inline) {
		switch (inline.$) {
			...
			case 2:
				...
				return $elm$core$Maybe$Just(
					$elm$core$Result$Ok(
						renderer.dn(
							{
								bl: $dillonkearns$elm_markdown$Markdown$Block$extractInlineText(children),
								aP: src,
								cf: title
							})));
			case 7:
			...
			case 8:
				return $elm$core$Maybe$Just(
					$elm$core$Result$Ok(renderer.di));
			default:
				var html = inline.a;
				if (!html.$) {
					var tag = html.a;
...
var $mdgriffith$elm_ui$Element$Font$strike = $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.ej);
var $author$project$Markdown$codeBlock = function (details) {
	return $author$project$Markdown$parseCodeBlock(details);
};
var $author$project$Markdown$parseCodeBlock = function (details) {
	var _v0 = details.bN;
	if (!_v0.$) {
		var lang = _v0.a;
		switch (lang) {
			case 'yaml':
				return $author$project$Markdown$formatCodeBlock(
					$mdgriffith$elm_ui$Element$text('(TODO) Render a form from this yaml block'));
			case 'markdown':
				var _v2 = $author$project$Markdown$viewMarkdown(details.cM);
				if (!_v2.$) {
					var rendered = _v2.a;
					return A2(
						$mdgriffith$elm_ui$Element$column,
			...
			default:
				return $author$project$Markdown$formatCodeBlock(
					$mdgriffith$elm_ui$Element$text(details.cM));
		}
	} else {
		return $author$project$Markdown$formatCodeBlock(
			$mdgriffith$elm_ui$Element$text(details.cM));
...
var $author$project$Markdown$viewMarkdown = function (markdown) {
	return A2(
		$elm$core$Result$andThen,
		$dillonkearns$elm_markdown$Markdown$Renderer$render(
			$author$project$Markdown$cyclic$renderer()),
		A2(
			$elm$core$Result$mapError,
			function (error) {
				return A2(
...
function $author$project$Markdown$cyclic$renderer() {
	return $author$project$Markdown$cyclic$defaultRenderer();
}
function $author$project$Markdown$cyclic$defaultRenderer() {
	return {
		cL: function (children) {
			return A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Border$widthEach(
						{cS: 0, dB: 10, d0: 0, eK: 0}),
						$mdgriffith$elm_ui$Element$padding(10),
						$mdgriffith$elm_ui$Element$Border$color(
		...
		c0: $author$project$Markdown$codeBlock,
		c1: $author$project$Markdown$code,
		da: function (content) {
			return A2(
				$mdgriffith$elm_ui$Element$row,
				_List_fromArray(
		...
		di: $mdgriffith$elm_ui$Element$html(
			A2($elm$html$Html$br, _List_Nil, _List_Nil)),
		dj: $author$project$Markdown$heading,
		dm: $dillonkearns$elm_markdown$Markdown$Html$oneOf(_List_Nil),
		dn: function (image) {
			var _v3 = image.cf;
			if (!_v3.$) {
				return A2(
		...
		dV: $mdgriffith$elm_ui$Element$paragraph(
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$spacing(15)
				])),
		...
		eo: $mdgriffith$elm_ui$Element$column(_List_Nil),
		ep: $mdgriffith$elm_ui$Element$column(_List_Nil),
		eq: F2(
			function (_v5, children) {
				return A2($mdgriffith$elm_ui$Element$paragraph, _List_Nil, children);
			}),
		er: $mdgriffith$elm_ui$Element$column(_List_Nil),
		es: F2(
			function (_v6, children) {
				return A2($mdgriffith$elm_ui$Element$paragraph, _List_Nil, children);
			}),
		et: $mdgriffith$elm_ui$Element$row(_List_Nil),
		aQ: $mdgriffith$elm_ui$Element$text,
		eH: $mdgriffith$elm_ui$Element$none,
		eO: function (items) {
			return A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
...
var $author$project$Markdown$renderer = $author$project$Markdown$cyclic$renderer();
$author$project$Markdown$cyclic$renderer = function () {
	return $author$project$Markdown$renderer;
};
var $author$project$Markdown$defaultRenderer = $author$project$Markdown$cyclic$defaultRenderer();
$author$project$Markdown$cyclic$defaultRenderer = function () {
	return $author$project$Markdown$defaultRenderer;
};
	...
	return {
		cM: _List_fromArray(
			[
				...
				{
					aZ: $author$project$Instructions$viewInstructionsFullPage(model.af),
					bs: $mdgriffith$elm_ui$Element$text(''),
					cf: 'Instructions'
				})
			]),
		cf: 'Chiron Portal'
...
var $author$project$Main$main = $elm$browser$Browser$document(
	{dr: $author$project$Main$init, en: $author$project$Main$subscriptions, eP: $author$project$Main$update, eR: $author$project$Main$view});
