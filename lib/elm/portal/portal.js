...
var $author$project$Main$Model = F7(
	function (editor, labStatus, instructions, viewFull, edit, labs, labName) {
		return {edit: edit, editor: editor, instructions: instructions, labName: labName, labStatus: labStatus, labs: labs, viewFull: viewFull};
	});
...
var $author$project$Main$init = function (maybelab) {
	var _default = A7(
		...
		{expectations: _List_Nil, overview: 'This is placeholder text for a short-summary about what this lab will cover'},
		'',
		false,
		false,
		_List_Nil,
...
var $author$project$Main$GotLabStatus = function (a) {
	return {$: 'GotLabStatus', a: a};
};
...
var $author$project$Main$LabStatus = F2(
	function (overview, expectations) {
		return {expectations: expectations, overview: overview};
	});
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$list = _Json_decodeList;
var $author$project$Main$labStatusDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Main$LabStatus,
	A2($elm$json$Json$Decode$field, 'overview', $elm$json$Json$Decode$string),
	A2(
		$elm$json$Json$Decode$field,
		'expectations',
		$elm$json$Json$Decode$list($elm$json$Json$Decode$string)));
var $author$project$Main$getLabStatus = F2(
	function (msg, lab) {
		return $elm$http$Http$get(
			{
				expect: A2($elm$http$Http$expectJson, msg, $author$project$Main$labStatusDecoder),
				url: $elm$core$String$concat(
					_List_fromArray(
						['/lab/', lab, '/status']))
			});
	...
	function (msg, model) {
		...
		switch (msg.$) {
			...
			case 'DispatchRunmd':
				...
				return _Utils_Tuple2(
					model,
					$author$project$Main$dispatchRunmd(runmd));
			case 'Instructions':
			...
			case 'CheckStatus':
				return _Utils_Tuple2(
					model,
					A2($author$project$Main$getLabStatus, $author$project$Main$GotLabStatus, model.labName));
			case 'GotLabStatus':
				var result = msg.a;
				if (result.$ === 'Ok') {
					var labStatus = result.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{labStatus: labStatus}),
...
var $author$project$Main$CheckStatus = {$: 'CheckStatus'};
...
var $author$project$Layout$viewFooter = function (model) {
	var width = model.showWorkspace ? A2($mdgriffith$elm_ui$Element$minimum, 2048, $mdgriffith$elm_ui$Element$fill) : $mdgriffith$elm_ui$Element$fill;
	...
	return A2(
		...
		A3(
			...
			A3(
				$elm$core$Basics$apL,
				$author$project$Layout$headerStyle(model.showWorkspace),
				width,
				height),
			backgroundColor,
			backgroundAltColor),
...
var $author$project$Layout$viewActions = function (model) {
	return A2(
...
var $author$project$Layout$viewContent = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$width(
				model.showWorkspace ? $mdgriffith$elm_ui$Element$fill : $mdgriffith$elm_ui$Element$fillPortion(3)),
				$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
				$author$project$Layout$defaultPadding
			]),
		_List_fromArray(
...
var $author$project$Layout$viewWorkspace = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
...
var $author$project$Layout$viewPage = function (model) {
	var shrinkContent = model.showWorkspace;
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		shrinkContent ? _List_fromArray(
			[
				$author$project$Layout$viewActions(model),
				$author$project$Layout$viewWorkspace(model),
...
var $author$project$Editor$viewMonacoEditor = function (model) {
	return $mdgriffith$elm_ui$Element$html(
		A3(
			...
			_List_fromArray(
				[
					A2($elm$html$Html$Attributes$attribute, 'value', model.text),
					A2($elm$html$Html$Attributes$attribute, 'language', model.language)
				]),
			_List_Nil));
};
...
var $author$project$Editor$viewMultilineEditor = F2(
	function (onChange, model) {
		return A2(
			...
			{
				label: $mdgriffith$elm_ui$Element$Input$labelHidden('Editor'),
				onChange: onChange,
...
var $author$project$Editor$viewCodeEditor = F3(
	function (msgs, settings, editor) {
		...
		var onSave = msgs.onSave;
		var onDispatch = msgs.onDispatchSave;
...
var $author$project$Layout$viewCommands = function (workspace) {
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					workspace ? {bottom: 0, left: 0, right: 1, top: 0} : {bottom: 0, left: 1, right: 0, top: 0}),
					$mdgriffith$elm_ui$Element$paddingEach(
					{bottom: 4, left: 14, right: 14, top: 4}),
					$mdgriffith$elm_ui$Element$Border$color(
...
var $author$project$Layout$viewStatus = function (workspace) {
	return function (commands) {
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
...
var $author$project$Instructions$viewExpectations = F2(
	function (onPress, expectations) {
		return A2(
			$author$project$Layout$viewStatus,
			true,
			A2(
				$elm$core$List$map,
				function (item) {
					return {
						label: $mdgriffith$elm_ui$Element$text(item),
						onPress: onPress
					};
				},
				expectations));
...
var $author$project$Markdown$headingOne = F2(
...
var $author$project$Markdown$headingTwo = F2(
	function (level, rawText) {
		return _List_fromArray(
			[
	...
	return A2(
		...
		function () {
			switch (level.$) {
				case 'H1':
					return A2(
						$author$project$Markdown$headingOne,
						$dillonkearns$elm_markdown$Markdown$Block$headingLevelToInt(level),
						rawText);
				case 'H2':
					return A2(
						$author$project$Markdown$headingTwo,
						$dillonkearns$elm_markdown$Markdown$Block$headingLevelToInt(level),
						rawText);
				default:
					return _List_fromArray(
...
var $author$project$Markdown$codeBlock = F2(
	function (onRunmd, details) {
		return A2($author$project$Markdown$parseCodeBlock, onRunmd, details);
	});
var $author$project$Markdown$defaultRenderer = function (onRunmd) {
	return {
		...
		codeBlock: $author$project$Markdown$codeBlock(onRunmd),
		codeSpan: $author$project$Markdown$code,
		...
		heading: $author$project$Markdown$heading,
...
var $author$project$Markdown$parseCodeBlock = F2(
	function (onRunmd, details) {
		var _v0 = details.language;
		if (_v0.$ === 'Just') {
			var lang = _v0.a;
			switch (lang) {
				case 'yaml':
				...
				case 'markdown':
					var _v2 = A2($author$project$Markdown$viewMarkdown, onRunmd, details.body);
					if (_v2.$ === 'Ok') {
						var rendered = _v2.a;
						return A2(
							$mdgriffith$elm_ui$Element$column,
								...
								[
									...
									A2(
										...
										_List_fromArray(
											[
												$mdgriffith$elm_ui$Element$Font$size(14),
												$mdgriffith$elm_ui$Element$moveRight(18),
												$mdgriffith$elm_ui$Element$Font$family(
												_List_fromArray(
													[
														$mdgriffith$elm_ui$Element$Font$typeface('system-ui')
										...
										{
											label: $mdgriffith$elm_ui$Element$text('Dispatch'),
											onPress: $elm$core$Maybe$Just(
												onRunmd(details.body))
										}))
								]),
							_List_fromArray(
								[
				...
				case 'runmd_create':
					return A2(
						...
						_List_fromArray(
							[
								$author$project$Markdown$formatCodeBlock(
								$mdgriffith$elm_ui$Element$text(details.body)),
								A2(
								$mdgriffith$elm_ui$Element$Input$button,
								_List_fromArray(
								...
								{
									label: $mdgriffith$elm_ui$Element$text('Create'),
									onPress: $elm$core$Maybe$Just(
										onRunmd(details.body))
								})
							]));
				case 'runmd_create_only':
					return A2(
						$mdgriffith$elm_ui$Element$Input$button,
						_List_fromArray(
							[
...
var $author$project$Markdown$renderer = function (onRunmd) {
	return $author$project$Markdown$defaultRenderer(onRunmd);
};
var $author$project$Markdown$viewMarkdown = F2(
	function (onRunmd, markdown) {
		return A2(
			$elm$core$Result$andThen,
			$dillonkearns$elm_markdown$Markdown$Renderer$render(
				$author$project$Markdown$renderer(onRunmd)),
			A2(
				$elm$core$Result$mapError,
				function (error) {
					return A2(
...
var $author$project$Instructions$viewFullPage = F2(
	function (onRunmd, markdown) {
		var _v0 = A2($author$project$Markdown$viewMarkdown, onRunmd, markdown);
		if (_v0.$ === 'Ok') {
			var rendered = _v0.a;
			return A2(
				$mdgriffith$elm_ui$Element$column,
...
var $author$project$Instructions$viewInstructions = F5(
	function (onRunmd, onNext, onViewFull, onDone, markdown) {
		var root = $author$project$Instructions$parser(
			$elm$core$String$lines(markdown));
		var _v0 = A2(
			$author$project$Markdown$viewMarkdown,
			onRunmd,
			A2($elm$core$String$join, '\n', root.value.content));
		if (_v0.$ === 'Ok') {
			var rendered = _v0.a;
...
var $author$project$Instructions$outline = F2(
	function (markdown, steps) {
		outline:
		while (true) {
			var root = $author$project$Instructions$parser(
				$elm$core$String$lines(markdown));
			if ($elm$core$List$isEmpty(root.remaining)) {
				return A2(
					$elm$core$List$append,
					steps,
					_List_fromArray(
				...
				var $temp$markdown = A2($elm$core$String$join, '\n', root.remaining),
					$temp$steps = A2(
					$elm$core$List$append,
					steps,
					_List_fromArray(
...
var $author$project$Instructions$viewHeaderOutlineItem = function (header) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
		...
		$mdgriffith$elm_ui$Element$text(
			A3(
				...
				'#',
				'',
				A3($elm$core$String$replace, '##', '\t', header))));
};
var $author$project$Instructions$viewOutline = F2(
	function (onPress, markdown) {
		var steps = A2($author$project$Instructions$outline, markdown, _List_Nil);
		return A2(
			...
			A2(
				...
				function (item) {
					return {
						label: $author$project$Instructions$viewHeaderOutlineItem(item.value.header),
						onPress: onPress(
							A2(
								$elm$core$String$join,
								'\n',
								$elm$core$List$concat(
									_List_fromArray(
										[item.value.content, item.remaining]))))
					};
				},
				steps));
	});
var $author$project$Main$view = function (model) {
	...
	var editorMessages = {
		...
		onSave: $author$project$Main$Save
	};
	var workspace = enableEdit ? A3($author$project$Editor$viewCodeEditor, editorMessages, editorSettings, editorModel) : A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						A2(
							...
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$text(model.labStatus.overview)
								])))
					])),
				A2(
				$mdgriffith$elm_ui$Element$column,
				...
				_List_fromArray(
					[
						...
						A2($author$project$Instructions$viewExpectations, $author$project$Main$CheckStatus, model.labStatus.expectations)
					])),
				A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$text('Outline')),
						A2($author$project$Instructions$viewOutline, $author$project$Main$Instructions, model.editor.text)
					]))
			]));
	return {
							...
							[
								...
								_List_fromArray(
									[
										...
										A2($author$project$Layout$viewCommands, false, labLinks)
									]))
							])),
