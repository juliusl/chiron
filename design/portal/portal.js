...
var $author$project$Layout$viewCommands = function (commands) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				...
				{bottom: 4, left: 10, right: 8, top: 4}),
				$mdgriffith$elm_ui$Element$Border$color(
								...
								[
									...
									A2(
										...
										_List_fromArray(
											[
												$mdgriffith$elm_ui$Element$Font$size(16),
												$mdgriffith$elm_ui$Element$moveLeft(20.0),
												$mdgriffith$elm_ui$Element$padding(8)
											]),
										{
											label: $mdgriffith$elm_ui$Element$text('Dispatch to chiron'),
		...
		body: _List_fromArray(
			[
				$author$project$Layout$view(
				{
					...
					title: '',
					workspace: A3($author$project$Editor$viewCodeEditor, editorMessages, editorSettings, editorModel)
				})
			]),
